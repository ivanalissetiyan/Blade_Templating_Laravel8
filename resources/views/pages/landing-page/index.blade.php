      ...
      <div>
        <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
          ...
          <div
            ...
            <p class="mb-8 leading-relaxed font-semibold text-sm" style="color: #c3cdfe">
              Ingin bergerak di bidang software house ?
            </p>
            <h1 class="text-white title-font sm:text-5xl lg:text-6xl text-4xl mb-8 font-semibold sm:leading-tight"
            ...
            <div
              ...
              <button
                class="btn-try inline-flex font-semibold text-black text-base py-4 px-6 rounded-xl mb-4 lg:mb-0 md:mb-0 focus:outline-none">
                Try it free
              </button>
              <button
          ...
          <div class="w-full lg:w-1/2 text-center lg:justify-end justify-center flex pr-0">
            <img id="hero"
              src="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header4/Header-4-4.png"
              alt="" />
          </div>
        </div>
      </div>
